...
normal). L'archive de release **`erp-ageroute-v2026.08.4.tar.gz`** (source
...
```bash
tar -xzf ~/erp-ageroute-v2026.08.4.tar.gz -C ~/erp-deploy/staging
```
...
v2026.08.4) ou re-extraire l'archive après avoir préservé le `.env`
